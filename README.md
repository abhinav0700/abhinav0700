...
- 🔭 I’m currently working on:
  ...
  - **Job portal platform (Apna/Naukri clone)**

- 🏆 Hackathon Achievements:
  - 🥈 Runner-up – Make-a-Thon (SVCE)
  - 🥈 Runner-up – Datatrix 2024 (SRM)
  - 🥉 Second Runner-up – Invente 2024 (SSN)
  - 🎖️ Special Mention – Hackathon ECW (Ethiraj College)
...
- 💼 **[Job Portal Clone (Apna/Naukri)](https://github.com/abhinav0700/job_portal)**  
  End-to-end job board with full-stack functionality using Supabase

- 🧾 **[Bank Statement Analyzer](https://github.com/abhinav0700/fundtrail)**  
  AI-powered app that detects fraud and financial flow using statement PDFs
